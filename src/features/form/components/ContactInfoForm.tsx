...
export const ContactInfoForm = ({
	contactInfo: { phone, phoneFamily, description, descriptionFamily, email },
	setContactInfo,
}: contactInfoPropsForm) => {
				...
				<InputForm
					...
					onChange={e => {
						...
						setContactInfo(contact => {
							return {
								...contact,
								phone: Math.abs(+e.target.value).toString(),
							};
						});
					}}
				/>
				...
				<InputForm
					...
					onChange={e => {
						setContactInfo(contact => {
							return {
								...contact,
								descriptionFamily: e.target.value,
							};
						});
					}}
				/>
